...
import Seccion1 from '../assets/Frentes-Interiores/Punto1Frente.webp'
import Lugar1 from '../assets/Frentes-Interiores/Punto1Frente.webp'
import Lugar2 from '../assets/Frentes-Interiores/Punto2Frente.webp'
import Lugar3 from '../assets/Robotica/Robotica5.webp'
import Lugar4 from '../assets/Frentes-Interiores/NodoSaladoFrente.webp'
import Lugar5 from '../assets/Frentes-Interiores/NodoElPuestoFrente1.webp'
import Lugar6 from '../assets/Frentes-Interiores/NodoCopaFrente1.webp'
...
const stats = [
  {
    ...
    backContent: (
      <div className="relative w-full h-full flex items-center justify-center scale-90">
        <img src="/Logos/NodoCopa.webp" className="w-1/2 absolute -translate-x-12 -rotate-12 drop-shadow-lg transition-transform group-hover:-translate-x-16" alt="Copa" />
        <img src="/Logos/NodoPuesto.webp" className="w-1/2 z-20 drop-shadow-2xl scale-110" alt="El Puesto" />
        <img src="/Logos/NodoSalado.webp" className="w-1/2 absolute translate-x-12 rotate-12 drop-shadow-lg transition-transform group-hover:translate-x-16" alt="El Salado" />
      </div>
    )
  },
  {
    ...
    color: "text-cyan-500",
    backContent: (
      <img src="/Logos/PuntoD.webp" className="w-3/5 drop-shadow-xl" alt="Punto Digital" />
    )
  },
  {
    numero: "1",
    ...
    backContent: (
      <img src="/Logos/Robotica-NyC.webp" className="w-3/5 drop-shadow-xl" alt="Robótica" />
    )
  }
];
...
const lugares = [
  ...
  // robotica
  {
    ...
    city: "Tinogasta, Catamarca",
    logo: "/Logos/Robotica-blanco.webp",
    img: Lugar3,
    maps: "https://maps.app.goo.gl/7bJfvYDj64B3f8FWA",
    from: "from-[#01EBE5]",
    to: "to-cyan-300",
  ...
  // Puesto 
  {
    ...
    address: "El Puesto",
    city: "El Puesto, Tinogasta, Catamarca",
    logo: "/Logos/NodoPuesto.webp",
    img: Lugar5,
...
function PyN() {
  ...
  const [activeLugar, setActiveLugar] = useState(null)
    ...
    <div className="bg-gradient-to-b from-slate-50 via-white to-slate-100 text-slate-800">
      ...
      <section className="relative w-full bg-slate-50 overflow-hidden pt-20
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none ">
          <motion.svg className="absolute -top-16 -left-16 w-[220px] h-[220px] sm:w-[300px] sm:h-[300px] lg:w-[600px] lg:h-[600px]"
            viewBox="0 0 600 600"
          ...
          <motion.svg className="absolute -bottom-10 md:-bottom-80 -right-50 md:-right-80  w-[350px] h-[350px] sm:w-[300px] sm:h-[300px] lg:w-[600px] lg:h-[600px]"
            viewBox="0 0 600 600"
            initial={{ opacity: 0, scale: 0.9, x: -100 }}
            whileInView={{ opacity: 1, scale: 1, x: 0 }}
          ...
          <motion.svg className="absolute top-1/2 left-1/6 md:top-8/8 md:left-1/6 -translate-x-1/2 -translate-y-1/2 w-[120px] h-[120px] sm:w-[180px] sm:h-[180px] lg:w-[300px] lg:h-[300px]"
            viewBox="0 0 600 600"
            initial={{ opacity: 0, scale: 0.9, x: -100 }}
            whileInView={{ opacity: 1, scale: 1, x: 0 }}
        ...
        >
          ...
          <motion.div className="order-1 lg:order-2
            ...
            <p className="mt-8 text-base sm:text-lg text-slate-900
      ...
      <section className="relative py-10 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48 overflow-hidden bg-slate-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-10 mb-16 sm:mb-28">
          {stats.map((stat, i) => (
            <motion.div
              ...
              onClick={() => isTouch && setActiveStat(activeStat === i ? null : i)}
        ...
        ${isTouch
                    ? activeStat === i && "[transform:rotateY(180deg)]"
                    : "group-hover:[transform:rotateY(180deg)]"
                  }`}
              >

                {/* FRENTE */}
                <div className="absolute inset-0 bg-white rounded-3xl shadow-xl flex flex-col items-center justify-center [backface-visibility:hidden]">
                  <h3 className={`text-5xl sm:text-6xl font-black ${stat.color}`}>
                    {stat.numero}
                  </h3>
                ...
                {/* DORSO */}
                <div className="absolute inset-0 bg-white rounded-3xl shadow-xl flex items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden] overflow-hidden">
                  {stat.backContent}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-14">
          {lugares.map((lugar, index) => (
            <motion.div
              key={index}
              className="group"
              onClick={() => isTouch && setActiveLugar(activeLugar === index ? null : index)}
            ...
            >
              ...
              <div
                className={`relative h-[400px] sm:h-[440px] md:h-[460px] w-full
        transition-transform duration-700
        [transform-style:preserve-3d]
        ${isTouch
                    ? activeLugar === index && "[transform:rotateY(180deg)]"
                    : "group-hover:[transform:rotateY(180deg)]"
                  }`}
              >
                ...
                <div className="absolute inset-0 bg-white rounded-3xl shadow-xl
                  ...
                  {/* Gradiente */}
                  <div
                    className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${lugar.from} ${lugar.to}
              ${isTouch
                        ? activeLugar === index
                          ? "translate-y-0"
                          : "translate-y-full"
              ...
              transition-transform duration-700 ease-out`}
                  ...
                  {/* LOGO (puede romper la card, pero no la sección) */}
                  <img
                    src={lugar.logo}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
                        {lugar.services.map((s, i) => (
                          <span key={i}
                            className="text-xs sm:text-sm bg-slate-50 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-900 font-medium border-slate-200">
                            {s}
                          </span>
                        ))}
                      </div>
