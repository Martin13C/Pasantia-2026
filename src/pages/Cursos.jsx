...
//     ];
    ...
    //                     className="mt-6 sm:mt-8 text-slate-800 text-base sm:text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed"
    //                 >
    ...
    //         {/* --- SECCIÓN DE FILTRADO --- */}
    //         {/* En mobile: sin margen negativo, full width con padding normal */}
    //         {/* En tablet/desktop: padding lateral creciente y margen negativo para overlap */}
    //         <section className="px-3 sm:px-6 md:px-16 lg:px-32 xl:px-48 relative z-30 mb-10 sm:mb-16 -mt-8 sm:-mt-20">
    ...
    //                         <div className="p-2.5 sm:p-3 bg-blue-600 rounded-xl sm:rounded-2xl text-white shadow-lg shadow-blue-100">
    ...
    //                             className="flex-1 w-auto flex items-center justify-center gap-3 py-4 bg-slate-900 text-white rounded-xl sm:rounded-2xl hover:bg-red-600 transition-all duration-300 font-black text-xs uppercase tracking-widest sm:self-end shadow-xl active:scale-95 group"
    //                         >
    ...
    //                     <div className="flex items-center gap-2 sm:gap-3 text-slate-400 font-black text-[10px] sm:text-[11px] uppercase tracking-[0.15em]">
    //                         <LayoutGrid strokeWidth={2.5} size={16} className="text-blue-500" />
    //                         Mostrando {cursosFiltrados.length} resultados encontrados
    //                     </div>
    //                     {searchTerm && (
    //                         <div className="text-[10px] font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full animate-pulse">
    ...
    //                                 tiltMaxAngleY={8}
    //                                 perspective={1500}
    //                                 /* En mobile la tilt puede interferir con el tap, se deshabilita */
    ...
    //                                             </h3>
    //                                             {/* fecha de curso */}
    //                                             <div className="text-[10px] font-bold text-slate-400 uppercase flex items-center gap-1.5 mb-2 tracking-wide">
    //                                                 <Calendar strokeWidth={2.5} size={13} className={colorScheme[curso.color].icon} />
    //                                                 Publicado: {curso.fechaPublicacion}
    //                                             </div>
    //                                             {/* descripcion del curso */}
    //                                             <p className="text-slate-500 text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6 font-medium">
    //                                                 {curso.descripcion}
    //                                             </p>
    ...
    //                                                         </div>
    //                                                         <div>
    //                                                             <p className="text-[9px] uppercase font-black text-slate-400 tracking-wider leading-none mb-0.5">{item.label}</p>
    ...
    //                                         <div className="w-full justify-center text-center items-center py-2 text-slate-400 text-[9px] font-extrabold tracking-widest uppercase transition-colors">
    //                                             hacer click para ver Flayer
    //                                         </div>
    ...
    //                                                     className={`w-full py-3 sm:py-4 ${colorScheme[curso.color].button} text-white uppercase rounded-xl sm:rounded-2xl text-[11px] sm:text-[12px] tracking-widest font-black flex items-center justify-center gap-2 shadow-md transition-transform active:scale-95 cursor-cell`}
    //                                                 >
    ...
    //                                             <p className="text-center text-white/40 text-[9px] font-bold uppercase tracking-widest">
    //                                                 Toca para volver a la info
    //                                             </p>
    //                                             <a
    //                                                 href={curso.urlRedes} target="_blank" rel="noopener noreferrer"
    //                                                 onClick={(e) => e.stopPropagation()}
    //                                                 className="w-full py-3 sm:py-4 bg-white text-slate-900 rounded-xl sm:rounded-2xl text-[11px] sm:text-[12px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-blue-50 transition-colors shadow-2xl"
    //                                             >
    ...
    //                     </motion.div>
    //                 ) : (
    //                     // mensaje por si no hay cursos encontrados
    //                     <motion.div
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {/* informar del click para el flayer */}
                        <div className="w-full justify-center text-center items-center py-2 text-slate-400 text-[9px] font-extrabold tracking-widest uppercase animate-pulse">
